...
\section{Findings}
The followin section overviews the findings following our implementation of the proposed solutions. We evaluate these findings in the next chapter.
\begin{itemize}
    ...
    \item \textbf{Noise and artefacts:} In several of the models, especially SRGAN-EfficientNetV2L, -MobileNetV2, and -VGG22 we can see clearly visible artefacts in the form of irregular pixel values. We can also see interesting grid like noise patterns in some of the reconstructions.
