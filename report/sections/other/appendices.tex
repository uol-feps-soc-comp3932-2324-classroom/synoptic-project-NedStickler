...
\begin{figure}[H]
    ...
    \caption{The five images that make up the Set5 evaluation set.}\label{fig:set5}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{The 14 images that make up the Set14 evaluation set.}\label{fig:set14}
\end{figure}
