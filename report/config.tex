...
\newcommand{\projectTitle}{A generative deep learning approach to super-resolution reconstruction in remote sensing}
\newcommand{\fullname}{Ned Stickler}
...
\vspace*{-15pt}
\includegraphics[scale=0.2,right]{./assets/logo_black.png}
\vspace*{-1pt}
\end{minipage}
